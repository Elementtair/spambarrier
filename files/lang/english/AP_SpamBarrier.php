...
'Yes'						=>	'Yes',
'No'						=>	'No',
'HP_description'				=>	'The HoneyPot is the first barrier against spammers. It permits to verify if the registration is (poorly) "automated" or not. It is strongly recommanded to enable this check, because it takes care of almost 100% of bots.',
...
'SFS_report_description'			=>	'Do we report spammers to StopForumSpam ? Please read <a href="http://www.stopforumspam.com/legal">"Acceptable use Policy"</a> before using. Requires an API key.',
...
'Search_description'				=>	'This feature allows you to search for users with URLs in their signatures but 0 posts. This is for finding spammers who have succeeded in passsing through the Honeypot and StopForumSpam checks. Search results will be limited to the latest 50 registered users meeting these criteria.',
'Go!'						=>	'Go!',
'No_match'					=>	'No match.',
